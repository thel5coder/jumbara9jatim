    ...
    export default {
        data(){
            return {
                ...
                user:{userName:'',password:'jumbara9jatim',userLevelId:'',contingentId:'',isActive:true},
                dict:{
                    custom:{
                        userName:{
        ...
        methods:{
            ...mapActions('UserStore',{createUser:'add'}),
            validateForm(){
                ...
                validator.validateAll().then((result)=>{
                    if(result){
                        this.createUser({input:this.user}).then((result)=>{
