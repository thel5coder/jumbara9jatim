<template>
    <div>
        <page-header :page-section="'Tambah Peserta'" :page-title="'Peserta'" :active-section="'Tambah'"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <fieldset class="content-group">
                                                            ...
                                                            <vue-dropzone ref="dropzonePhotograph" id="dropzone"
                                                                          :headers="headersDrop" :options="dropzonePhoto"
                                                                        v-on:vdropzone-file-added="dropzonePhotographFileAdded"></vue-dropzone>
                                                        </fieldset>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <fieldset class="content-group">
                                                            <legend class="text-bold">Unggah Asuransi </legend>
                                                            <vue-dropzone ref="dropzoneAnsurance" id="dropzone" :options="dropzoneInsurance"
                                                                          v-on:vdropzone-file-added="dropzoneInsuranceFileAdded"></vue-dropzone>
                                                        </fieldset>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <fieldset class="content-group">
                                                            <legend class="text-bold">Unggah KTA MIS </legend>
                                                            <vue-dropzone ref="dropzoneMis" id="dropzone" :options="dropzoneKta"
                                                                          v-on:vdropzone-file-added="dropzoneKtaFileAdded"></vue-dropzone>
                                                        </fieldset>
                                                    </div>
                                                </div>
...
<script>
    ...
    export default {
        data(){
            return {
                participant:{mis:'',fullName:'',contingentId:'',birthPlace:'',birthDate:'',sex:'Laki - laki',religion:'',address:'',phone:'',groupMember:'',
                    positionId:'',email:'',photograph:'',ansurance:'',misImage:'',isActive:true},
                ...
                dropzoneKta:{
                    ...
                    renameFile(file){
                        ...
                        let extension = fileType.toString().split('/')
                        let uniqe = new Date()
                        return 'kta'+uniqe.getTime()+'.'+extension[1]
                    }
                },
                dict:{
                    en:{
        ...
        methods:{
            ...mapActions('ParticipantStore',{createParticipant:'add'}),
            validateForm(){
                ...
                validator.validateAll().then((result)=>{
                    if(result){
                        ...
                        let response = this.createParticipant({input:this.participant,})
            ...
            // },
            dropzoneInsuranceFileAdded(file){
                this.participant.ansurance = file.upload.filename
            },
            dropzoneKtaFileAdded(file){
                this.participant.misImage = file.upload.filename
            },
            dropzonePhotographFileAdded(file){
                this.participant.photograph = file.upload.filename
                console.log(this.participant.photograph)
            }
        }
    }
</script>
